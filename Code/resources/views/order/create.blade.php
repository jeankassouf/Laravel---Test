...
<div class="card">
		...
		<form method="post" action="{{route('order-store')}}">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<input type="text" class="form-control" id="first_name" name="first_name">{{old('first_name')}}</text>
					@error('first_name')
			...
			<div class="col-md-6">
				...
				<input type="text" class="form-control" id="last_name" name="last_name">{{old('last_name')}}</text>
				@error('last_name')
				<span class="text-danger">{{$message}}</span>
				@enderror
			</div>
	...
	<div class="row">
		<div class="col-md-6">
			...
			<input type="text" class="form-control" id="email" name="email">{{old('email')}}</text>
			@error('email')
			<span class="text-danger">{{$message}}</span>
			@enderror
		</div>
	...
	<div class="col-md-6">
		...
		<input type="number" class="form-control" id="phone" name="phone">{{old('phone')}}</text>
		@error('phone')
		<span class="text-danger">{{$message}}</span>
		@enderror
	</div>
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<input type="number" class="form-control" id="post_code" name="post_code">{{old('post_code')}}</text>
		@error('post_code')
		<span class="text-danger">{{$message}}</span>
		@enderror
	</div>
...
<div class="row">
	<div class="col-md-12">
		<div class="form-group">
			...
			<textarea class="form-control" id="address1" name="address1">{{old('address1')}}</textarea>
			@error('address1')
			<span class="text-danger">{{$message}}</span>
			@enderror
		</div>
